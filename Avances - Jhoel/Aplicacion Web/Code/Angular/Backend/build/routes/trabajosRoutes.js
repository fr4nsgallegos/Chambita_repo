...
class TrabajosRoutes {
    ...
    config() {
        ...
        this.router.get('/:idTrabajo', trabajosController_1.default.getOne);
        this.router.post('/', trabajosController_1.default.create);
        this.router.put('/:idTrabajo', trabajosController_1.default.update);
        this.router.delete('/:idTrabajo', trabajosController_1.default.delete);
    }
}
